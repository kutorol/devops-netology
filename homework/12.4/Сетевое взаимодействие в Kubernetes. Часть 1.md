...
Манифест располагается [тут](./1-dep.yaml)

Деплой, сервис и отдельный под

![](./1.png)

Получение доступа по доменному имени из отдельного под по разным портам
...
Манифест располагается [тут](./2-svc.yaml)

Скрин запуска всех ресурсов

![](./3.png)

Скрин получения доступа с локальной машины к ноде с открытыми портами
